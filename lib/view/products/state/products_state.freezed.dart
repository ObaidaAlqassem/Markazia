...
mixin _$ProductsState {
  AsyncValue<List<Product>>? get productsList =>
...
abstract class $ProductsStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({AsyncValue<List<Product>>? productsList});
}
...
class _$ProductsStateImpl implements _ProductsState {
  const _$ProductsStateImpl({required this.productsList});
  ...
  @override
  String toString() {
    return 'ProductsState(productsList: $productsList)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, productsList);
...
abstract class _ProductsState implements ProductsState {
  const factory _ProductsState(
          {required final AsyncValue<List<Product>>? productsList}) =
      _$ProductsStateImpl;
